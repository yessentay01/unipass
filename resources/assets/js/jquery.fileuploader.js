        ...
        thumbnails: {
			...
			item: '<li class="fileuploader-item">' +
                       '<div class="columns">' +
                           ...
                           '<div class="column-actions">' +
                               '<a class="fileuploader-action fileuploader-action-remove" title="Remover arquivo"><i></i></a>' +
                           '</div>' +
                       '</div>' +
            ...
            item2: '<li class="fileuploader-item">' +
                        '<div class="columns">' +
                            ...
                            '</a>' +
                            '<div class="column-actions">' +
                                '<a href="${file}" class="fileuploader-action fileuploader-action-download" title="Baixar arquivo" download><i></i></a>' +
                                '<a class="fileuploader-action fileuploader-action-remove" title="Remover arquivo"><i></i></a>' +
                            '</div>' +
                        '</div>' +
                    '</li>',
